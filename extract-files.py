...
namespace_imports = [
    'device/alldocube/T811M',
    'external/wpa_supplicant_8',
    'hardware/mediatek',
    'hardware/mediatek/libmtkperf_client',
    'hardware/millennium',
    'vendor/alldocube/T811M',
]
...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/mt6789/lib3a.flash.so', 'vendor/lib64/mt6789/lib3a.ae.stat.so', 'vendor/lib64/mt6789/lib3a.sensors.flicker.so', 'vendor/lib64/mt6789/lib3a.sensors.color.so', 'vendor/lib64/mt6789/libaaa_ltm.so', 'vendor/lib64/lib3a.ae.pipe.so'): blob_fixup()
